...
#define SERV_0_HEADER "LocomotionTestHarness.h"
// the name of the Init function
#define SERV_0_INIT InitLocomotionTestHarness
// the name of the run function
#define SERV_0_RUN RunLocomotionTestHarness
...
#if NUM_SERVICES > 1
// the header file with the public function prototypes
#define SERV_1_HEADER "Locomotion.h"
// the name of the Init function
#define SERV_1_INIT InitLocomotion
// the name of the run function
#define SERV_1_RUN RunLocomotion
// How big should this services Queue be?
...
// the name of the Init function
#define SERV_2_INIT InitMorseElements
// the name of the run function
