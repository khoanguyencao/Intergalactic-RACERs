...
#define SERV_0_HEADER "IR.h"
// the name of the Init function
#define SERV_0_INIT InitIR
// the name of the run function
#define SERV_0_RUN RunIR
...
#if NUM_SERVICES > 1
// the header file with the public function prototypes
#define SERV_1_HEADER "IRTestHarness.h"
// the name of the Init function
#define SERV_1_INIT InitIRTestHarness
// the name of the run function
#define SERV_1_RUN RunIRTestHarness
// How big should this services Queue be?
...
typedef enum
{
  ...
  ES_FREQ1, ES_FREQ2, ES_FREQ3, ES_FREQ4, ES_BLINK, ES_RX_BATON, ES_LEFTDETECT, 
          ES_RIGHTDETECT, ES_BOTH_DETECT, ES_NO_DETECT, ES_FREQ_CHANGE, ES_TX_BATON, ES_RECEIVE
}ES_EventType_t;
